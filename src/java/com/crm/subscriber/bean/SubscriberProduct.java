...
public class SubscriberProduct implements Serializable {
    ...
    private boolean isFreeRegistered = false;
    ...
    public boolean isFreeRegistered() {
        return isFreeRegistered;
    }

    public void setFreeRegistered(boolean isFreeRegistered) {
        this.isFreeRegistered = isFreeRegistered;
    }
}
